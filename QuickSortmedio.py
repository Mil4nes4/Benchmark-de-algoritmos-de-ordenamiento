def quick_sortmedio(arr, low=0, high=None):
    if high is None:
        high = len(arr) - 1
    ...
    if low < high:
        ...
        quick_sortmedio(arr, low, pi - 1)
        quick_sortmedio(arr, pi + 1, high)

def partition(arr, low, high):
    # Seleccionamos el pivote como el elemento del medio
    mid = (low + high) // 2
